...
>
> 随后我进一步尝试了运用 go.work，于是有了 [嵌套 go.mod 有可能吗](https://hedzr.com/golang/nested-go-modules-is-it-possible)，即本文。
>

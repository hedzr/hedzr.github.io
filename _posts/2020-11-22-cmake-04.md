...
last_modified: 2020-11-23 10:23:00 +0800
Author: hedzr
...
excerpt: >-
  CMake 相关，Basics Part I：基本语法结构、流程控制...
---
...
其中，参数可以为空，括号之间的内容允许被分列于多行中。例如一个实例：
...
CMake 推崇你指令名一律小写，内建变量名一律大写，至于由脚本编写者如你所建立的变量名则视个人偏好而定。

...
Author: hedzr
tags: [c++, cmake-hello, cmake, build]
...
[Policies](https://www.mankier.com/7/cmake-policies) 不知道该译作政策、准则还是前提条件，或者是约定？所以干脆不译了，反正当年搞 C++ Template 时我也从未翻译过 policy。
